...
SOURCEFILES_QUOTED_IF_SPACED=main.c PIC_config.c ili9341.c i2c_master_noint.c i2c_accelerometer.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/PIC_config.o ${OBJECTDIR}/ili9341.o ${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/i2c_accelerometer.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/PIC_config.o.d ${OBJECTDIR}/ili9341.o.d ${OBJECTDIR}/i2c_master_noint.o.d ${OBJECTDIR}/i2c_accelerometer.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/PIC_config.o ${OBJECTDIR}/ili9341.o ${OBJECTDIR}/i2c_master_noint.o ${OBJECTDIR}/i2c_accelerometer.o

# Source Files
SOURCEFILES=main.c PIC_config.c ili9341.c i2c_master_noint.c i2c_accelerometer.c
...
${OBJECTDIR}/i2c_accelerometer.o: i2c_accelerometer.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/i2c_accelerometer.o.d 
	@${RM} ${OBJECTDIR}/i2c_accelerometer.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c_accelerometer.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_accelerometer.o.d" -o ${OBJECTDIR}/i2c_accelerometer.o i2c_accelerometer.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/i2c_accelerometer.o: i2c_accelerometer.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/i2c_accelerometer.o.d 
	@${RM} ${OBJECTDIR}/i2c_accelerometer.o 
	@${FIXDEPS} "${OBJECTDIR}/i2c_accelerometer.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/i2c_accelerometer.o.d" -o ${OBJECTDIR}/i2c_accelerometer.o i2c_accelerometer.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD) 
